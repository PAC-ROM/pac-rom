...
**How to use Gerrit [Guide] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/HowToUseGerrit.md)**

**Getting Started: Preparing and building [Linux Guide] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/PrepareForBuildLinux.md) or [Mac OS Guide] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/PrepareForBuildMac.md)**

**Device isn't supported? Not a problem! [Read] (https://github.com/PAC-ROM/android_vendor_pac/blob/pac-6.0/docs/BecomeAMaintainer.md)**
